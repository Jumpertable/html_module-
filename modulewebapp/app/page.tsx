    ...
    <div className="grid place-items-center min-h-screen bg-white">
      ...
      <div className="border-2 border-black rounded bg-white w-full  max-w-lg pt-10 p-4 grid">
        ...
        <div className="relative border-2 border-green-300 rounded bg-green-400 text-gray-900 text-center py-9 w-full h-80  max-w-lg grid place-items-center">
          ...
          <div className="absolute right-110 w-12  max-w-lg h-22 bg-white rounded-r-full"></div>
          <div className="absolute top-64 left-91 w-28  max-w-lg h-19 bg-white rounded-l-full"></div>
